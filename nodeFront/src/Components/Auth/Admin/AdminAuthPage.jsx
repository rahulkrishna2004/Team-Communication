    ...
    <div className="h-screen flex items-center justify-center bg-gradient-to-r">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 overflow-hidden">
        <div className="text-center mb-6">
           <div className=" ">
              <img src="./logo.png" className="h-15 w-15 rotate-10 absolute" alt="" />
             <h1 className="text-2xl font-semibold py-2"> Welcome to  <span className="text-blue-500">Appli Track </span> </h1>
            </div>
         <u> <h1 className="text-3xl font-bold text-gray-800 ">
